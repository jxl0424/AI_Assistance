...
class FeedbackSystem:
    ...
    def play_beep(self, frequency=1000, duration=0.1, volume=0.3):
        """
        Play a beep sound
    ...
    def activation_beep(self):
        ...
        self.play_beep(frequency=800, duration=0.1, volume=0.3)
    ...
    def print_action(self, action, target):
        """Print parsed action"""
        print(f"{Fore.BLUE}Action: {action} -> {target}{Style.RESET_ALL}")
